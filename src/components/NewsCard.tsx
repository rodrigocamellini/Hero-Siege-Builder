...
export function NewsCard({ title, description, image, btnText }: { title: string; description: string; image: string; btnText: string }) {
  return (
    <div className="pixel-card bg-white flex flex-col group hover:border-brand-orange transition-all duration-300">
      ...
      <div className="p-6 flex flex-col flex-1 text-center">
        ...
        <button className="orange-button w-full py-2.5 text-[10px] tracking-[0.2em] mt-auto">{btnText}</button>
      </div>
    </div>
  );
}
